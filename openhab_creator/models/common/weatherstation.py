...
class DWDEvent(CreatorEnum):
    ...
    STARKE_HITZE = 11, 'STARKEHITZE', 'Starke Hitze'
    FROST = 22, 'FROST', 'Frost'
    GLAETTE = 24, 'GLÄTTE', 'Glätte'
    GEWITTER = 31, 'GEWITTER', 'Gewitter'
    STARKES_GEWITTER = 33, 'STARKESGEWITTER', 'Starkes Gewitter'
    ...
    STURMBÖEN = 53, 'STURMBÖEN', 'Sturmböen'
    SCHWERE_STURMBOEEN = 53, 'SCHWERESTURMBÖEN', 'Sturmböen'
    ORKANARTIGE_BOEEN = 54, 'ORKANARTIGEBÖEN', 'Orkanartige Böen'
    ORKANBOEEN = 55, 'ORKANBÖEN', 'Orkanböen'
    EXTREME_ORKANBOEEN = 56, 'EXTREMEORKANBÖEN', 'Extreme Orkanböen'
    NEBEL = 59, 'NEBEL', 'Nebel'
    STARKREGEN = 61, 'STARKREGEN', 'Starkregen'
    HEFTIGER_STARKREGEN = 62, 'HEFTIGERSTARKREGEN', 'Heftiger Starkregen'
    DAUERREGEN = 64, 'DAUERREGEN', 'Dauerregen'
    ERGIEBIGER_DAUERREGEN = 64, 'ERGIEBIGERDAUERREGEN', 'Ergiebiger Dauerregen'
    EXTREM_ERGIEBIGER_DAUERREGEN = 65, 'EXTREMERGIEBIGERDAUERREGEN', 'Extrem ergiebiger Dauerregen'
    EXTREM_HEFTIGER_STARKREGEN = 66, 'EXTREMHEFTIGERSTARKREGEN', 'Extrem heftiger Starkregen'
    LEICHTER_SCHNEEFALL = 70, 'LEICHTERSCHNEEFALL', 'Leichter Schneefall'
    SCHNEEFALL = 71, 'SCHNEEFALL', 'Schneefall'
    STARKER_SCHNEEFALL = 72, 'STARKERSCHNEEFALL', 'Starker Schneefall'
    EXTREM_STARKER_SCHNEEFALL = 73, 'EXTREMSTARKERSCHNEEFALL', 'Extrem starker Schneefall'
    SCHNEEVERWEHUNG = 74, 'SCHNEEVERWEHUNG', 'Schneeverwehung'
    STARKE_SCHNEEVERWEHUNG = 75, 'STARKESCHNEEVERWEHUNG', 'Starke Schneeverwehung'
    ...
    GLATTEIS = 85, 'GLATTEIS', 'Glatteis'
    TAUWETTER = 88, 'TAUWETTER', 'Tauwetter'
    STARKES_TAUWETTER = 89, 'STARKESTAUWETTER', 'Starkes Tauwetter'
    SCHWERES_GEWITTER = 93, 'SCHWERESGEWITTER', 'Schweres Gewitter'
    EXTREMES_GEWITTER = 93, 'EXTREMESGEWITTER', 'Extremes Gewitter'
    ...
    def __init__(self, identifier: int, keyword: str, label: str):
        self.identifier: int = identifier
        self.keyword: str = keyword
        self.label: str = label

    @classproperty
    def mappings_keyword(self) -> Dict[str, str]:
        return dict(map(lambda dwdevent: (dwdevent.keyword, dwdevent.identifier),
                        DWDEvent))

    @classproperty
    def mappings_label(self) -> Dict[str, str]:
